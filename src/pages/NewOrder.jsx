        ...
        <div className='neworderpage bg-secondary'>
            ...
            <form onSubmit={handleSubmit} className='submitorder'>
                ...
                <div className="mb-3 w-100">
                    ...
                    <input type="number" name='card16digit' className="form-control" id="card16digit" value={order.card16digit} onChange={handleChange} autoComplete='off' required placeholder='1234 5678 9012 3456' />
                </div>
                <div className='order'>
